        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="stat-card group hover:shadow-lg">
                <div class="flex items-center gap-3 mb-4">
                    <div class="icon-container icon-container-md bg-gradient-to-br from-amber-500 to-orange-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="card-modern overflow-hidden p-0">
                <div class="px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 flex justify-between items-center">
                    ...
                    <a href="{{ route('filament.chauffeur.resources.transfer-bookings.index') }}" class="text-sm text-white/80 hover:text-white font-medium flex items-center gap-1">
                        Voir tout
            ...
            <div class="card-modern overflow-hidden p-0">
                <div class="px-6 py-4 bg-gradient-to-r from-amber-500 to-orange-600 flex justify-between items-center">
                    ...
                    <a href="{{ route('filament.chauffeur.resources.delivery-bookings.index') }}" class="text-sm text-white/80 hover:text-white font-medium flex items-center gap-1">
                        Voir tout
                        <x-heroicon-o-arrow-right class="w-4 h-4" />
                    </a>
                </div>
