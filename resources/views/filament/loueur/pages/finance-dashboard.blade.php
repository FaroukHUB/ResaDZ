            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <a href="{{ route('filament.loueur.resources.transfer-bookings.index') }}" class="text-sm text-primary-600 hover:text-primary-700 font-medium">
                            Voir tout
                        </a>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <a href="{{ route('filament.loueur.resources.delivery-bookings.index') }}" class="text-sm text-primary-600 hover:text-primary-700 font-medium">
                            Voir tout
                        </a>
                    </div>
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 dark:text-gray-300">Entrees</span>
                            <span class="text-lg font-bold text-green-600">+{{ number_format($todayIncome ?? 0, 0, ',', ' ') }} DA</span>
                        </div>
                        <div class="flex justify-between items-center">
            ...
            <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm text-amber-800 dark:text-amber-200">Revenus en attente (reservations confirmees/en cours)</p>
                        <p class="text-lg font-bold text-amber-900 dark:text-amber-100">{{ number_format($pendingIncome ?? 0, 0, ',', ' ') }} DA</p>
                    </div>
                </div>
            </div>
            @endif
