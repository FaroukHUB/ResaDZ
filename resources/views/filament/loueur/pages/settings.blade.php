<x-filament-panels::page>
    {{-- Welcome Banner --}}
    <div class="welcome-banner mb-6 rounded-2xl px-6 py-5 md:px-8 md:py-6 relative overflow-hidden" style="background: linear-gradient(135deg, #FF6B2C 0%, #F59E0B 100%); box-shadow: 0 8px 32px rgba(255,107,44,0.25);">
    ...
    {{-- Guide Section --}}
    <div class="mb-6 rounded-2xl p-5 animate-slide-up" style="background: linear-gradient(135deg, #FFF7ED 0%, #FFFBEB 100%); border: 1px solid rgba(255,107,44,0.15); box-shadow: 0 4px 24px rgba(255,107,44,0.06);">
        <div class="flex items-start gap-3">
            <div class="icon-container w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 4px 12px rgba(255,107,44,0.3);">
            ...
            <div class="flex-1">
                ...
                <div class="text-sm mt-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3" style="color: #9A3412;">
                    <div class="flex items-start gap-2 p-2.5 bg-white/70 dark:bg-gray-800/50 rounded-xl" style="transition: all 0.2s ease;" onmouseenter="this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 12px rgba(255,107,44,0.1)'" onmouseleave="this.style.transform='';this.style.boxShadow=''">
                        <div class="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B);">
    ...
    <form wire:submit="save">
        <div class="card-modern mb-6" style="box-shadow: 0 4px 24px rgba(255,107,44,0.08);">
            {{ $this->form }}
        </div>

        <div class="flex justify-end">
            <x-filament::button type="submit" size="lg" class="btn-gradient-primary" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); border: none; box-shadow: 0 4px 14px rgba(255,107,44,0.3); border-radius: 0.75rem; transition: all 0.2s ease; padding: 0.75rem 2rem;">
    ...
    <div class="mt-8 card-modern" x-data="{ showHelp: false }" style="box-shadow: 0 4px 24px rgba(255,107,44,0.08);">
        <div class="flex items-start gap-4">
            <div class="icon-container w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 6px 20px rgba(255,107,44,0.3);">
            ...
            <div class="flex-1">
                <div class="flex items-center gap-3">
                    ...
                    <button
                        ...
                        class="w-6 h-6 flex items-center justify-center rounded-full text-white hover:scale-110 transition-transform text-xs font-bold" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 2px 8px rgba(255,107,44,0.3);"
                ...
                {{-- Help Panel --}}
                <div x-show="showHelp" x-transition x-cloak class="mt-4 card-modern border" style="background: linear-gradient(135deg, #FFF7ED, #FFFBEB); border-color: rgba(255,107,44,0.2); box-shadow: 0 4px 24px rgba(255,107,44,0.08);">
                    <div class="flex items-start gap-3 mb-4">
                        <div class="icon-container w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 4px 12px rgba(255,107,44,0.25);">
                    ...
                    <div class="space-y-3 text-sm">
                        {{-- Google Chrome --}}
                        <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl" style="box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.2s ease;" onmouseenter="this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 16px rgba(255,107,44,0.1)'" onmouseleave="this.style.transform='';this.style.boxShadow='0 2px 8px rgba(0,0,0,0.04)'">
                        ...
                        {{-- Mobile --}}
                        <div class="flex items-start gap-3 p-4 rounded-xl" style="background: linear-gradient(135deg, #FFF7ED, #FFFBEB); border: 1px solid rgba(255,107,44,0.2);">
                            <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B);">
                    ...
                    <button
                        ...
                        class="mt-4 w-full btn-modern text-sm text-white font-semibold py-2.5 rounded-xl" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 4px 14px rgba(255,107,44,0.3); transition: all 0.2s ease;"
                    >
                        Fermer l'aide
                    </button>
                </div>
                ...
                <div class="mt-6">
                    <button
                        ...
                        class="btn-modern text-white font-semibold py-2.5 px-5 rounded-xl inline-flex items-center" style="background: linear-gradient(135deg, #FF6B2C, #F59E0B); box-shadow: 0 4px 14px rgba(255,107,44,0.3); transition: all 0.2s ease;"
                    >
