...
@section('title', 'Connexion - ResaDZ')
    ...
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-gray-50 px-4 text-gray-400">ou</span>
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <a href="{{ route('register') }}" class="inline-flex items-center gap-2 mt-2 px-6 py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-700 transition shadow-lg">
