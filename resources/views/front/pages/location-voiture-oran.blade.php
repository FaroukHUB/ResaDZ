...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        { "@@type": "ListItem", "position": 3, "name": "Location voiture Oran", "item": "{{ url('/location-voiture-oran') }}" }
    ]
}
</script>
@endsection
...
<section class="bg-gray-900 py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="text-sm text-gray-400 mb-6">
            ...
            <span class="mx-2">/</span>
            <span class="text-white">Location voiture Oran</span>
        </nav>
        ...
        <div class="mt-8">
            <a href="/vehicules?wilaya=oran" class="inline-flex items-center gap-2 px-8 py-4 bg-green-600 text-white font-bold rounded-lg hover:bg-green-500 transition text-lg">
                Voir les voitures disponibles à Oran
...
<section class="bg-gray-50 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Prix location voiture Oran en 2026</h2>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-right font-bold" style="color: #FF6B2C;">8 000 – 9 500 DA</td>
                    </tr>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 font-bold text-gray-900">Van 7 places</td>
                        <td class="px-6 py-4 text-gray-600">Espace, Expert, Caddy</td>
                        <td class="px-6 py-4 text-right font-bold" style="color: #FF6B2C;">11 000 – 16 000 DA</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<section class="bg-white py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Où récupérer votre voiture à Oran</h2>
            <p class="mt-2 text-gray-500">La wilaya d'Oran est étendue. Voici les zones où la logistique est la plus simple.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-lg hover:border-green-200 transition-all">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <h3 class="font-bold text-gray-900 text-lg">Aéroport Ahmed Ben Bella (Es Sénia)</h3>
                </div>
            ...
            <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-lg hover:border-green-200 transition-all">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <h3 class="font-bold text-gray-900 text-lg">Centre-ville (Place 1er Novembre)</h3>
                </div>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Coeur historique d'Oran, proche du front de mer et des hôtels. Pratique pour les séjours touristiques ou professionnels en centre-ville.
                </p>
            </div>
            ...
            <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-lg hover:border-green-200 transition-all">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <h3 class="font-bold text-gray-900 text-lg">Aïn El Türck & Corniche</h3>
                </div>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Côte ouest d'Oran, accès aux plages et stations balnéaires. Indispensable en été pour profiter du littoral oranais sans dépendre des transports.
                </p>
            </div>
        </div>
    </div>
...
<section class="bg-gray-50 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Documents nécessaires pour louer à Oran</h2>
        </div>
...
<section class="bg-gray-50 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Questions fréquentes — location voiture Oran</h2>
        </div>
        ...
        <div class="space-y-4" x-data="{ open: null }">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <button x-on:click="open = open === 1 ? null : 1" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                    <span class="font-bold text-gray-900">Peut-on se faire livrer la voiture à Oran ?</span>
                ...
                <div x-show="open === 1" x-collapse class="px-6 pb-5">
                    <p class="text-gray-600">Oui. La plupart des loueurs sur ResaDZ proposent la livraison à l'aéroport Ahmed Ben Bella, à votre hôtel ou à une adresse de votre choix dans la wilaya d'Oran.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <button x-on:click="open = open === 2 ? null : 2" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                    <span class="font-bold text-gray-900">Y a-t-il des loueurs disponibles le weekend ?</span>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <button x-on:click="open = open === 3 ? null : 3" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                    <span class="font-bold text-gray-900">Peut-on louer pour aller à Mostaganem ou Tlemcen ?</span>
                ...
                <div x-show="open === 3" x-collapse class="px-6 pb-5">
                    <p class="text-gray-600">Oui, la plupart des loueurs acceptent les trajets inter-wilayas. Vérifiez les conditions de kilométrage du loueur avant de réserver et précisez votre destination dans le message.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <button x-on:click="open = open === 4 ? null : 4" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                    <span class="font-bold text-gray-900">Les prix changent-ils en été ?</span>
                ...
                <div x-show="open === 4" x-collapse class="px-6 pb-5">
                    <p class="text-gray-600">Oui, entre juillet et août les tarifs montent de 20 à 30% sur toute la région oranaise. Réservez au moins 2 semaines à l'avance pendant cette période.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <button x-on:click="open = open === 5 ? null : 5" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                    <span class="font-bold text-gray-900">Un permis français est-il accepté ?</span>
                ...
                <div x-show="open === 5" x-collapse class="px-6 pb-5">
                    <p class="text-gray-600">Oui, les permis français, belge et canadien sont acceptés par les loueurs sur ResaDZ. Beaucoup de loueurs oranais proposent la livraison directe à l'aéroport dès votre arrivée.</p>
                </div>
            </div>
        </div>
        ...
        <script type="application/ld+json">
        {
            ...
            "mainEntity": [
                {
                    "@@type": "Question",
                    "name": "Peut-on se faire livrer la voiture à Oran ?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "Oui. La plupart des loueurs sur ResaDZ proposent la livraison à l'aéroport Ahmed Ben Bella, à votre hôtel ou à une adresse de votre choix dans la wilaya d'Oran."
                    }
                },
                {
                    "@@type": "Question",
                ...
                {
                    "@@type": "Question",
                    "name": "Peut-on louer pour aller à Mostaganem ou Tlemcen ?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "Oui, la plupart des loueurs acceptent les trajets inter-wilayas. Vérifiez les conditions de kilométrage du loueur avant de réserver et précisez votre destination dans le message."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "Les prix changent-ils en été ?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "Oui, entre juillet et août les tarifs montent de 20 à 30% sur toute la région oranaise. Réservez au moins 2 semaines à l'avance pendant cette période."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "Un permis français est-il accepté ?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "Oui, les permis français, belge et canadien sont acceptés par les loueurs sur ResaDZ. Beaucoup de loueurs oranais proposent la livraison directe à l'aéroport dès votre arrivée."
                    }
                }
            ]
        }
...
<section class="bg-gradient-to-r from-green-900 via-green-800 to-green-900 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl lg:text-4xl font-black text-white tracking-tight">Trouvez votre voiture à Oran sur ResaDZ</h2>
        ...
        <div class="mt-8">
            <a href="/vehicules?wilaya=oran" class="inline-flex items-center gap-2 px-8 py-4 bg-white text-green-900 font-bold rounded-lg hover:bg-gray-100 transition text-lg shadow-xl">
                Voir les voitures disponibles à Oran
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
            </a>
        </div>
