        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative -mt-16 lg:-mt-20">
                ...
                <form action="{{ route('vehicles.index') }}" method="GET" class="bg-[#252525] rounded-2xl p-6 lg:p-10 shadow-2xl border border-gray-800">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date"
                                   ...
                                   min="{{ date('Y-m-d') }}"
                                   class="w-full px-4 py-4 bg-[#1a1a1a] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="pickup_time"
                                    class="w-full px-4 py-4 bg-[#1a1a1a] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-colors appearance-none cursor-pointer">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                <label class="relative">
                                    ...
                                    <div class="px-4 py-3 bg-[#1a1a1a] border border-gray-700 rounded-xl text-center cursor-pointer transition-all peer-checked:border-amber-500 peer-checked:bg-amber-500/10 hover:border-gray-600">
                    ...
                    <div class="mt-8">
                        <button type="submit"
                                class="w-full md:w-auto md:min-w-[300px] md:mx-auto md:flex px-8 py-4 bg-amber-500 hover:bg-amber-600 text-black font-bold rounded-xl transition-all shadow-lg shadow-amber-500/20 flex items-center justify-center gap-3">
