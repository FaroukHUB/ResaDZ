...
// Filtre uniquement les véhicules Audi
        ...
        <?php if (!empty($brandVehicles)): ?>
          <?php foreach ($brandVehicles as $veh): ?>
            <?php
              ...
              // -----------------------------
              // CONDITION PHOTO NON CONTRACTUELLE
              // Match si modèle contient un intervalle : "XXXX à XXXX"
              // -----------------------------
              $isNonContractuelle = (
                  isset($veh['model'])
            ...
            <article class="card-veh" data-title="<?php echo htmlspecialchars($fullName); ?>">
              ...
              <!-- ✨ INSERTION PHOTO NON CONTRACTUELLE JUSTE SOUS LA PHOTO -->
              <?php if ($isNonContractuelle): ?>
                <p class="card-note" style="text-align:center; font-size:0.82rem; margin:6px 0 0; color:#999;">
                  Photo non contractuelle : plusieurs modèles selon les années.
                </p>
              <?php endif; ?>
              <!-- ✨ FIN INSERTION -->
