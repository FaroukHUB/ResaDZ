...
class BookingController extends Controller
{
    ...
    public function store(StoreBookingRequest $request, PricingService $pricingService, OptionAvailabilityService $optionService)
    {
        ...
        $booking = Booking::create([
            ...
            'client_id_document' => $request->hasFile('client_id_document') ? $request->file('client_id_document')->store('bookings/documents', 'public') : null,
            'client_license_front' => $request->hasFile('client_license_front') ? $request->file('client_license_front')->store('bookings/documents', 'public') : null,
            'client_license_back' => $request->hasFile('client_license_back') ? $request->file('client_license_back')->store('bookings/documents', 'public') : null,
