...
class OnboardingChauffeur extends Page implements Forms\Contracts\HasForms
{
    ...
    protected static string $view = 'filament.loueur.pages.onboarding-chauffeur';

    protected static ?string $slug = 'onboarding-chauffeur';
                    ...
                    Forms\Components\Grid::make(3)
                        ->schema([
                            Forms\Components\Checkbox::make('offers_transfer')
                                ->label('✈️ Transferts aéroport/gare')
                                ->live(),
                            Forms\Components\Checkbox::make('offers_city_rides')
                                ->label('🏙️ Courses en ville'),
            ...
            Forms\Components\Section::make('Paiement PayPal')
                ...
                ->schema([
                    ...
                    Forms\Components\TextInput::make('paypal_email')
                        ...
                        ->helperText('Vos clients pourront payer directement sur votre PayPal. Vérifiez que cet email est bien lié à votre compte actif.')
    ...
    public function previousStep()
    {
        ...
        return redirect()->route('filament.loueur.pages.onboarding-chauffeur');
    }
